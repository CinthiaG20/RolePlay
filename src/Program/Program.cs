...
IItem martilloDeGuerra = new IItem("Martillo de Guerra", 15, 5); //se crea un item con nombre Martillo de Guerra, ataque 15 y defensa 5
IItem armaduraValiriana = new IItem("Armadura Valiriana", 0, 20); //se crea un item con nombre Armadura Valiriana, ataque 0 y defensa 20
...
IItem baston = new IItem("Bastón Mágico", 10, 0); //se crea un item con nombre Bastón Mágico, ataque 10 y defensa 3
IItem capa = new IItem("Capa Mágica", 0, 10); //se crea un item con nombre Capa Mágica, ataque 0 y defensa 10
...
IItem bastonGigante = new IItem("Bastón de Hielo", 10, 3);//se crea un item con nombre Bastón de Hielo, ataque 10 y defensa 3
IItem capain = new IItem("Capa de Sigilo", 0, 10);//se crea un item con nombre Capa de Sigilo, ataque 0 y defensa 10
...
IItem arco = new IItem("Arco de yggdrasil", 12, 0); //se crea un item con nombre Arco de yggdrasil, ataque 12 y defensa 0
IItem tunicaElfica = new IItem("Túnica Élfica", 0, 8); //se crea un item con nombre Túnica Élfica, ataque 0 y defensa 8
